...
File Name   : c_PigeonLocation_Handle.h
Requires    : LinuxAS3 , Oracle 9i
Create Date : 2016-05-04
******************************************************************************/

#ifndef C_PigeonLocation_HANDLER_H
#define C_PigeonLocation_HANDLER_H
...
class TCPigeonLocationHandler{
	private:
		//: 初始化相关的数据
		void Init();	
	public:
		TCPigeonLocationHandler();
