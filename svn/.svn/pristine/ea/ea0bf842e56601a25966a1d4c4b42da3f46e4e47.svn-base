...
Description : 通用结构体定义
File Name   : c_PigeonLocation_Public.h
Requires    : LinuxAS3 , Oracle 9i
Create Date : 2016-05-04
******************************************************************************/


#ifndef C_PigeonLocation_PUBLIC_H
#define C_PigeonLocation_PUBLIC_H
...
#define LOG_INFO(fmt, ...) \
    ...
    { \
        ...
        TCPigeonLocationLog  *g_TCPigeonLocationLog; \
        g_TCPigeonLocationLog->AddPigeonLocationRunLog(arrLog);\
    }while(0);
