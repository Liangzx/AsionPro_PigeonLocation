...
File Name   : c_PigeonLocation_Handle.cpp
...
// 说明 :
//==========================================================================
TCPigeonLocationHandler::TCPigeonLocationHandler(){
  	Init();
}
//==========================================================================
// 函数 :    
...
//==========================================================================
// 函数 : TCPigeonLocationHandler::Init
// 用途 : 对内部变量进行初始化
// 原型 : Init()
// 参数 : 无
// 返回 : 无
// 说明 : 
//==========================================================================
void TCPigeonLocationHandler::Init(){
	return;    
}


//==========================================================================
// 函数 : TCPigeonLocationHandler::LoadAllCellPosInfo
// 用途 : 加载全网工参信息
...
// 说明 : 加载全网工参信息
//==========================================================================
bool TCPigeonLocationHandler::LoadAllCellPosInfo(){
	try{ 		
...
//==========================================================================
// 函数 : TCPigeonLocationHandler::TrackerLoginCheck
// 用途 : 用户认证
...
// 说明 : 查询该用户是否正常用户；
//==========================================================================
bool TCPigeonLocationHandler::TrackerLoginCheck(TCString sImei, TCString sImsi, TCString sDev_Type, TCString sICCID, int nErrorCode){
	try{ 
...
//==========================================================================
// 函数 : TCPigeonLocationHandler::GetPushCommandList
...
//==========================================================================
bool TCPigeonLocationHandler::GetPushCommandList(vector<TCString> &vsPush_Cmd_List){
	try{   
    TCString sSQL="SELECT  status from mb_bss_terminal_info where  imei=:F1IMEI<char[17]>";
...
//==========================================================================
// 函数 : TCPigeonLocationHandler::GetSFNCmdParam
// 用途 : 查询 SFN 命令需要的参数
// 原型 : GetSFNCmdParam()
// 参数 : 无
// 返回 : 无
// 说明 : 查询 SFN 命令需要的参数
//==========================================================================
bool TCPigeonLocationHandler::GetSFNCmdParam(TCString sCustID, map<int, TCString> &msIdxID_FamilyMsisdn, otl_datetime &MaxTimer){
	try{   
...
//==========================================================================
// 函数 : TCPigeonLocationHandler::UpdateSFNCmdParamStatus
// 用途 : 更新SFN设置状态
...
// 说明 : 更新SFN设置状态
//==========================================================================
bool TCPigeonLocationHandler::UpdateSFNCmdParamStatus(TCString sCustID, otl_datetime &MaxTimer){
	try{   
...
//==========================================================================
// 函数 : TCPigeonLocationHandler::RecordTrackerStatus
// 用途 : 状态码登记处理
...
// 说明 : 状态码登记处理
//==========================================================================
bool TCPigeonLocationHandler::RecordTrackerStatus(TCString sCustID, TCString sStatus_Code){
	try{   
...
//==========================================================================
// 函数 : TCPigeonLocationHandler::RecordTrackerLocationInfo
// 用途 : 用户位置信息登记
...
// 说明 : 用户位置信息登记
//==========================================================================
bool TCPigeonLocationHandler::RecordTrackerLocationInfo(TCString sCustID,TCString sImei, TCString sImsi, str_Space_Pos_Unit sPosNode, int nPower_Level, int nLoc_Type,  TCString sTimeStamp, str_Lac_Cell_Node sLBSNode, int nRxLev){
	try{   
		if(!gPigeonLocationConfig->IsOpenLBSLocation() && abs(sPosNode.dLongitude-0.00001)<=0.0001 && abs(sPosNode.dLatitude-0.00001)<=0.0001 ){
